...
select o1.custid, o1.empid from sales.orders o1 where o1.orderdate between '2016-01-01' and '2016-01-31'
except
select o2.custid, o2.empid from sales.orders o2 where o2.orderdate between '2016-02-01' and '2016-02-29'
...
select o3.custid, o3.empid from sales.orders o3 where o3.orderdate like '2015-%';
